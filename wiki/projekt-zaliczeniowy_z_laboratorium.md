...
Nie musisz przewijać całej sekcji — kliknij, aby przejść od razu do modułu oceniania.
...
* 2
  ...
  **Laboratoria nr 4/5 — repozytorium i projekt aplikacji**
  Link do repo na Moodle, opis w README, dodanie innych studentów jako testerów.
* 3

  **Laboratoria nr 6 — wersja beta**
  Pełna funkcjonalność, wstępne testy, refaktoryzacja kodu.
* 4
...
**Ważna zasada**
Kod projektu musi być oryginalny. Dozwolone jest korzystanie z bibliotek open-source i oficjalnej
dokumentacji. Niedozwolone jest kopiowanie gotowych projektów. Plagiat skutkuje oceną
niedostateczną.
...
[Zobacz plik projekt-zaliczeniowy.md w wiki](wiki/projekt-zaliczeniowy.md)  
