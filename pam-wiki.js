...
const ARTICLES = {
    ...
    'mobile-security-basics': 'wiki/mobile-security-basics.md',
    ...
    'android-lint':         'wiki/android-lint.md',
    ...
    'jak-stworzyc-pwa':    'wiki/jak-stworzyc-pwa.md',
    ...
    'opencog-architecture':      'wiki/opencog-architecture.md',
    ...
    'neurogaming':          'wiki/neurogaming.md',
    ...
    'itchio-android':       'wiki/itchio-android.md',
...
const METADATA = {
    ...
    'mobile-security-basics': { category: 'Projektowanie i OS',           title: 'Mobile Security Basics',                   icon: 'fa-solid fa-user-shield' },
    ...
    'android-lint':         { category: 'Programowanie natywne Android',  title: 'Android Lint - analiza statyczna kodu',    icon: 'fa-solid fa-magnifying-glass-chart' },
    ...
    'jak-stworzyc-pwa':    { category: 'Cross-platform i PWA',           title: 'Jak stworzyć stronę PWA',                  icon: 'fa-solid fa-rocket' },
    ...
    'opencog-architecture':      { category: 'Informatyka afektywna',          title: 'Architektury kognitywne: ACT-R, Soar, OpenCog',                  icon: 'fa-solid fa-brain' },
    ...
    'itchio-android':       { category: 'Gry mobilne',                    title: 'itch.io i publikacja gier Android APK',    icon: 'fa-solid fa-upload' },
    ...
    'neurogaming':           { category: 'Gry mobilne',                    title: 'Neurogaming - gry sterowane mózgiem',               icon: 'fa-solid fa-brain' },
    ...
    'litert-lm-android':     { category: 'Lokalna AI na urządzeniu',       title: 'LiteRT LM na Androidzie - implementacja praktyczna', icon: 'fa-brands fa-android' },
    'litert-lm-npu':         { category: 'Lokalna AI na urządzeniu',       title: 'LiteRT LM i akceleracja NPU',                        icon: 'fa-solid fa-microchip' },
    'google-maven':          { category: 'Programowanie natywne Android',  title: 'Google Maven - zarządzanie zależnościami Android',   icon: 'fa-brands fa-google' },
...
const CATEGORIES = [
    ...
    { id: 'cat-games',    name: 'Gry mobilne',                    icon: 'fa-solid fa-gamepad',              articles: ['mobile-games','lua-mobile-games','unity-advanced','game-physics','game-monetization','itchio-android','gamedev-market','small-engine-games','frotz-zmachine','serious-games','neurogaming'] },
