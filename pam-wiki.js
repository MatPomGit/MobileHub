...
const CATEGORIES = [
    ...
    { id: 'cat-games',    name: 'Gry mobilne',                    icon: 'fa-solid fa-gamepad',              articles: ['mobile-games','lua-mobile-games','unity-advanced','game-physics','game-monetization','gamedev-market','small-engine-games','serious-games'] },
